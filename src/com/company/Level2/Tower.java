...
public class Tower {
    public int[] solution(int[] heights) {
        ...
        //자바는 기본적으로 배열에 0을 세팅해주지 않아도 0이 들어가지만,
        //다른 언어로 작성시에는 이 부분도 주의해줘야 할 것 같다.

        int[] answer = new int[heights.length];
        for(int i=heights.length -1;i>0;i--){ //오른쪽에서 왼쪽으로 레이저를 쏨. 등대 순서를 한 번씩 지나간다.
            for(int j=i;j>0;j--){ //자신보다 높은 등대를 찾기 위한 포문
